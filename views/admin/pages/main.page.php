...
if ( isset( $_POST['edit_wc_timeline_config'] ) && wp_verify_nonce( $_POST['edit_wc_timeline_config'], 'edit_wc_timeline_config' ) ) {
    ...
    $config->modal_cart_notices_timeout = (int) $_POST['modal_cart_notices_timeout'];
    $config->upsells_carousel_autoplay = ( isset( $_POST['upsells_carousel_autoplay'] ) ? 1 : 0 );
    $config->upsells_carousel_autoplay_speed = (int) $_POST['upsells_carousel_autoplay_speed'];
    /*
...
?> 
                                        ...
                                        <div class="row is-beta">       
                                                <div class="heading"><?php 
_e( 'Autoplay the upsells carousel', 'woo_j_cart' );
?></div>
                                                <div class="option">
                                                        <label class="wc-timeline-switch">
                                                                <input name='upsells_carousel_autoplay' <?php 
echo  ( woo_j_conf( 'upsells_carousel_autoplay' ) === 1 ? 'checked' : '' ) ;
?> type="checkbox" class="has-text">
                                                                <span class="slider"></span>
                                                                <span class="text-content" data-yes="<?php 
_e( 'yes', 'woo_j_cart' );
...
?>"></span>
                                                ...
                                                <div class="option has-attribute medium">  
                                                        <span class="attribute">ms</span>                                                       
                                                        <input min="0" name="upsells_carousel_autoplay_speed" value="<?php 
echo  woo_j_conf( 'upsells_carousel_autoplay_speed' ) ?? 2000 ;
?>" type="number">                               
                                                </div>
                                                <div class="tips">
                                                        <?php 
_e( 'Make the upsells carousel autoplay, if present. Set the time between each slide (in milliseconds)', 'woo_j_cart' );
?> 
                                                </div>
                                        </div>
                                </div>
