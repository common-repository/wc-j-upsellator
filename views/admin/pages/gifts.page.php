...
if ( isset( $_POST['admin_upsellator_nonce'] ) && wp_verify_nonce( $_POST['admin_upsellator_nonce'], 'admin_upsellator_nonce' ) ) {
    ...
    if ( isset( $_POST['id'] ) && is_numeric( $_POST['id'] ) ) {
        ...
        if ( $_POST['action'] == 'add' || $_POST['action'] == 'update' ) {
            ...
            $p_gift['clickable'] = ( isset( $_POST['clickable'] ) ? 1 : 0 );
...
?>
                    ...
                    <div class="wp-timeline-admin-box upsell-gift-wrapper--container hidden new-gift-wrapper"> 
...
?>
                                                        ...
                                                        <div class="option has-attribute">
                                                                        <label class="wc-timeline-switch">
                                                                                <input name='clickable' type="checkbox" class="has-text">
                                                                                <span class="slider"></span>
                                                                                <span class="text-content" data-yes="<?php 
_e( 'yes', 'woo_j_cart' );
?>" data-no="<?php 
