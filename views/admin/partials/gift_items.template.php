...
if ( !empty($active_gifts) ) {
    foreach ( $active_gifts as $gift ) {
        ...
        ?>
                        ...
                        <div class="row-wrapper  upsell-gift-wrapper--container product-wrapper closed gift-wrapper" data-gift="<?php 
        echo  $gift['id'] ;
        ?>">
        ...
        ?>
                                                ...
                                                <div class="option">                                                                                  
                                                        <select name="new_product_id" data-id="<?php 
        echo  esc_attr( $gift['id'] ) ;
        ?>"  data-parentvisible="0" required data-security="<?php 
        echo  wp_create_nonce( 'search-products' ) ;
        ?>" class="wc-upsellator-product-search selected_product select2-hidden-accessible product-search" style="width: 100%;" data-placeholder="<?php 
        ...
        ?>
                                        ...
                                        <div class="row">
                                                <div class="heading">
                                                        <?php 
        _e( 'Clickable', 'woo_j_cart' );
        ?>
                                                </div>
                                                <div class="option has-attribute">
                                                                <label class="wc-timeline-switch">
                                                                        <input name='clickable' <?php 
        echo  ( isset( $gift['clickable'] ) && $gift['clickable'] === 1 ? 'checked' : '' ) ;
        ...
        ?>"></span>
                                                ...
                                                <div class="tips">
                                                        <?php 
        _e( 'Make the gift product clickable (to related product page)', 'woo_j_cart' );
        ?>
                                                </div>
                                        </div>
