        ...
        */
        ...
        foreach ( $cart->get_cart() as $cart_item ) {
            ...
            if ( !empty($cart_item['upsell']) ) {
                ...
                $new_price = apply_filters( 'wjufw_upsell_sale_price', $this->calculateUpsellPrice( $product_id, $backend_upsell ) );
    ...
    */
    public function markAsUpsell( $cart_item_data, $product_id, $variation_id )
    {
        ...
        if ( $is_upsell && empty($cart_item_data['gift']) && isset( woo_j_upsell( 'products' )[$id] ) ) {
            ...
            $cart_item_data['custom_price'] = $this->calculateUpsellPrice( $id, $backend_upsell );
    ...
    private function calculateUpsellPrice( $id, $upsell_product )
    {
        ...
        $percentage = ( $upsell_product['discount_type'] == 1 ? $upsell_product['discount'] : $upsell_product['discount'] * 100 / get_post_meta( $id, '_regular_price', true ) );
