...
class UpsellatorProduct
{
            ...
            if( $filtered_product->exists() && $product['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $product, $product['key'] ?? null ) ) 
            {
                    ...
                    if( $this->isNotDeletedGift( $filtered_product, $product ) )
                    {
                            ...
                            */
                            ...
                            $this->url                  = $this->getProductURL(  $filtered_product );       
    ...
    */
    ...
    {      
        ...
        if( !$this->isGift() ) return $product->get_permalink();

        if( !isset( woo_j_gift('products')[ $this->id ]['clickable'] ) || ( woo_j_gift('products')[ $this->id ]['clickable'] == 0 ) ) return '#';
    ...
    private function prepareHeading()
    {
            ...
            {   
                ...
                {   
                    ...
                    {
                        return  wjc__( woo_j_upsell('products')[ $this->id ]['heading'], 'upsell_heading_' . $this->id );
                    }  
                }
            ...
            if( $this->isGift() )
            {            
                return wjc__( woo_j_gift('products')[ $this->id ]['heading'], 'gift_heading_' . $this->id );
            }
    ...
    */
    private function prepareDescription()
    {
            ...
            */
            ...
            {        
                    return  wjc__( woo_j_upsell('products')[ $this->id ][ 'text' ], 'upsell_text_' . $this->id );
            }
            /*
            ...
            */
            ...
            {        
                    return  wjc__( woo_j_gift('products')[ $this->id ][ 'text' ] , 'gift_text_' . $this->id );
            }
    ...
    */
    ...
    private function calculatePrice( $product )
    {
        ...
        */
        ...
        {
                $price = isset( $product['woosb_price'] ) ? $product['woosb_price'] : $product['data']->get_price(); 
