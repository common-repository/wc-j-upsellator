...
class OptionConfig extends BaseOption
{
    ...
    protected function setDefaults()
    {
        ...
        $this->upsells_carousel_autoplay = false;
        $this->upsells_carousel_autoplay_speed = "5000";
        $this->save();
    }
    ...
    public function save()
    {
        ...
        $settings['upsells_carousel_autoplay'] = $this->upsells_carousel_autoplay;
        $settings['upsells_carousel_autoplay_speed'] = $this->upsells_carousel_autoplay_speed;
